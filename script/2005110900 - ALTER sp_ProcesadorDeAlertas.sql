		...
		--BEGIN TRANSACTION
			...
			BEGIN
				...
				BEGIN
					...
					--Obtenemos el texto representativo y el codigo de la alerta que inicia el proceso
					SELECT @textoRepresentativo = TextoRepresentativo, @codigoTramite = CodigoTramite
