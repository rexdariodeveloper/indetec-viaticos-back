		...
		--BEGIN TRANSACTION
			...
			BEGIN 
				...
				BEGIN
					...
					IF (@alertaDefinicionId = @ALERTA_DEFINICION_SOLICITUD_VIATICOS_AUTORIZACION_ID OR @alertaDefinicionId = @ALERTA_DEFINICION_SOLICITUD_VIATICOS_AUTORIZADA_ID)
					BEGIN
					...
					IF (@empleadoAutorizar IS NOT NULL AND @alertaDefinicionId = @ALERTA_DEFINICION_SOLICITUD_VIATICOS_AUTORIZACION_ID)
					BEGIN
