USE [Viaticos]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_getListadoInformeComprobacionPorUsuarioId]    Script Date: 6/25/2020 3:50:57 PM ******/
SET ANSI_NULLS ON
GO
...
-- Description:	Agregar el estatus En Revision Comprobacion 1000107
-- ===========================================================
...
(
	...
	WHERE solicitud.EstatusId IN(1000161, 1001167, 1000107)
