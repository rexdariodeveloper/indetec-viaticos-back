...
(
	SELECT solicitud.SolicitudViaticoId AS Id,
		   ...
		   Motivo,
		   CONVERT(VARCHAR, solicitud.FechaSalida, 103) AS FechaSalida,
		   CONVERT(VARCHAR, solicitud.FechaRegreso, 103) AS FechaRegreso,
		   ...
		   CONVERT(VARCHAR, comprobacion.FechaUltimaModificacion, 103) AS FechaFinalizacionFormato,
