...
(
	...
	FROM cte AS arbol
		 ...
		 LEFT JOIN tblPermisoAcceso AS acceso ON nodo.PermisoAccesoId = acceso.PermisoAccesoId AND acceso.Borrado = 0 AND acceso.UsuarioId = @usuarioId AND acceso.TipoPermisoId = 1000013
)