USE [Viaticos]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_getListadoRevisionSolicitudViatico]    Script Date: 6/16/2020 1:34:08 PM ******/
SET ANSI_NULLS ON
GO
...
-- Description:	Cambiar el estatus a Comprobacion Finalizar
-- =============================================
